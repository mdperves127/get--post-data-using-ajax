    ...
    <div class="container row justify-content-center mb-5" id="post-details" data-post-id="{{ $post->id }}">
        ...
        <div class="mt-2">
            ...
            <form method="POST" id="comment-form-submit">
                @csrf
                <textarea id="comment-input" name="comment" rows="4" placeholder="Enter comment" class="form-control"></textarea>
                <div id="comment-error-data" class="text-danger"></div>
                <br>
                <button id="save-comment-button" type="submit" class="btn btn-success">Save</button>
            </form>
